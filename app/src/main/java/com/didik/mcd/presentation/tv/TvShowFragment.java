...
public class TvShowFragment extends Fragment implements TvShowListener {
    ...
    private Observer<List<TvShow>> getTvShows = new Observer<List<TvShow>>() {
        @Override
    ...
    private Observer<Boolean> getStateLoading = new Observer<Boolean>() {
        @Override
    ...
    private void setUpViewModel() {
        ...
        viewModel.getStateLoading().observe(this, getStateLoading);
        viewModel.getErrorMessage().observe(this, getErrorMessage);
...
//        intent.putExtra(TvShowDetailActivity.EXTRA_TV_SHOW, tvShowList.get(position));
//        startActivity(intent);
        Toast.makeText(getActivity(), tvShowList.get(position).getOriginalName(), Toast.LENGTH_SHORT).show();
    }
}
